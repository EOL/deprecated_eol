...
describe TaxonConcept do
  ...
  it "should be able to filter common_names by taxon_concept or hierarchy_entry" do
    # by taxon_concept
    common_names = @taxon_concept.common_names_cleaned_and_sorted
    ...
    common_names = @taxon_concept.common_names_cleaned_and_sorted(hierarchy_entry_id: hierarchy_entry.id)
    common_names.count.should > 0
  end
