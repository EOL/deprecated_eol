  ...
  xml.dataObject do
    ...
    unless minimal
      ...
      if data_object.is_image?
        xml.mediaURL ContentServer.image_cache_path(data_object.object_cache_url, :orig, :host => $SINGLE_DOMAIN_CONTENT_SERVER) unless data_object.object_cache_url.blank?
        xml.thumbnailURL ContentServer.image_cache_path(data_object.object_cache_url, '98_68', :host => $SINGLE_DOMAIN_CONTENT_SERVER) unless data_object.object_cache_url.blank?
        ...
        xml.thumbnailURL ContentServer.image_cache_path(data_object.thumbnail_cache_url, '260_190', :host => $SINGLE_DOMAIN_CONTENT_SERVER) unless data_object.thumbnail_cache_url.blank?
