...
mileage may, of course, vary:
  ...
  29. vim config/deploy/v2staging.rb    # if it's not me.
  30. cap v2staging deploy -S tag=notify.02
  31. chmod -R /var/www to your user if you have perms errors
  32. erb -x -T '-' app/views/notifier/recent_activity.erb | ruby -c
