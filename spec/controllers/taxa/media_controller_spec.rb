...
describe Taxa::MediaController do
  ...
  describe 'GET index' do
    ...
    before(:all) do
      ...
      newest_image_poorly_rated_trusted_association = @newest_image_poorly_rated_trusted.an_association(:taxon_concept => @taxon_concept)
      ...
      oldest_image_highly_rated_unreviewed_association = @oldest_image_highly_rated_unreviewed.an_association(:taxon_concept => @taxon_concept)
      ...
      highly_ranked_image_association = @highly_ranked_image.an_association(:taxon_concept => @taxon_concept)
      ...
      newest_video_poorly_rated_trusted_association = @newest_video_poorly_rated_trusted.an_association(:taxon_concept => @taxon_concept)
      ...
      oldest_video_highly_rated_unreviewed_association = @oldest_video_highly_rated_unreviewed.an_association(:taxon_concept => @taxon_concept)
      ...
      highly_ranked_video_association = @highly_ranked_video.an_association(:taxon_concept => @taxon_concept)
      ...
      newest_sound_poorly_rated_trusted_association = @newest_sound_poorly_rated_trusted.an_association(:taxon_concept => @taxon_concept)
      ...
      oldest_sound_highly_rated_unreviewed_association = @oldest_sound_highly_rated_unreviewed.an_association(:taxon_concept => @taxon_concept)
      ...
      highly_ranked_sound_association = @highly_ranked_sound.an_association(:taxon_concept => @taxon_concept)
      ...
      highly_ranked_text_association = @highly_ranked_text.an_association(:taxon_concept => @taxon_concept)
