...
gem 'haml', '4.0.4'
# http://www.rubysec.com/advisories/OSVDB-96425/ TODO - this can be removed once
# we update redis/resque.
...
# TODO - remove this, Rails has something like this baked in. I forget what it's
# called.
