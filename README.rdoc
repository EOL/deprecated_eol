...
To install memcached on OSX with MacPorts already on the system is quite easy:
  ...
  1. Run "sudo port install memcached".  This will install the packages required.
  2. At the end of the output from this, it should recommend you run another command, probably "sudo launchctl load
