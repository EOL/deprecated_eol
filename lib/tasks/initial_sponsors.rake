...
namespace :initial_sponsors do
  ...
  task :add_initial_sponsors => :environment do
    ...
    InstitutionalSponsor.create(name: "Chinese Academy of Sciences", logo_url: Rails.configuration.partner_logos + "", url: "http://english.cas.cn/", active: true)
    ...
    InstitutionalSponsor.create(name: "Smithsonian Institution", logo_url: Rails.configuration.partner_logos + "nmnh.gif", url: "http://www.si.edu/", active: true)
  end
end
