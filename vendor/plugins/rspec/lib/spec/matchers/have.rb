  ...
  module Matchers
    ...
    class Have #:nodoc:
      ...
      def method_missing(sym, *args, &block)
        @collection_name = sym
        # changed this because i kept getting depreciation warnings when running specs
        # Inflector is depreciated, use ActiveSupport::Inflector instead
        @plural_collection_name = ActiveSupport::Inflector.pluralize(sym.to_s) if defined? ActiveSupport::Inflector
        @args = args
        @block = block
        self
      end
