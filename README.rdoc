...
Your mileage may, of course, vary:
  ...
  10. sudo apt-get install rake libxml2
...
occur if object serialization failed. You may need to find all of the "$CACHE" calls in the code and use YAML to
...
==== Metric_fu is Not Included

To use Metric Fu, you must install the gem YOURSELF.  It is the team's opinion
that metric-fu, and it's various dependencies, are system level tools (like
ruby-debug) and should not be checked into the code base.

==== Use

  rake metrics:all # Runs metrics on EOL
