...
CREATE TABLE `data_objects` (
  ...
  `rights_holder` text COMMENT 'a string stating the owner of copyright for this object',
...
CREATE TABLE `hierarchies` (
  ...
  `description` text COMMENT 'not required; a more verbose description describing the hierarchy. Could be a paragraph describing what it is and what it contains',
