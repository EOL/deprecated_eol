...
describe TaxonConceptExemplarImagesController do
  ...
  describe 'PUT set_as_exemplar' do
    it 'should not allow non-curators to set exemplar images' do
      ...
      expect{ put :update, :taxon_concept_exemplar_image => { :taxon_concept_id => @taxon_concept.id, :data_object_id => exemplar_image.id } }.to raise_error(EOL::Exceptions::SecurityViolation)
    end
    ...
    it 'should set an image as exemplar' do
      ...
      exemplar_image = @taxon_concept.images_from_solr.first
      put :update, :taxon_concept_exemplar_image => { :taxon_concept_id => @taxon_concept.id, :data_object_id => exemplar_image.id }
