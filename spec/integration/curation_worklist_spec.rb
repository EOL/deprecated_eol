...
describe 'Curator Worklist' do
  # TODO: I commented out the before all as none of the specs were enabled and it was took 35 seconds for me
  # before(:all) do
  #   commit_transactions
  #   truncate_all_tables
  ...
  it 'should show a list of unreviewed images in the curator\'s clade when curator visits the worklist'
  ...
  # # end
  # #
  it 'should be able to maintain the curator\'s session'
  ...
  it 'should be able to give curators a warning message if content is not found'
