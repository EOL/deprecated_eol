...
class DataPointUri < ActiveRecord::Base
  ...
  def apply_unit_conversion
    conversions = [
      ...
      # TODO - we should probably replace these (english) strings with the method names generated by KnownUri#set_defaults,
      # but there are no tests for it at present, so I'm keeping them as-is for now:
