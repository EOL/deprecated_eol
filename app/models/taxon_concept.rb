...
class TaxonConcept < SpeciesSchemaModel
  ...
  def text(options={})
    ...
    text_user_objects = users_data_objects.select{ |udo| udo.data_object.is_text? && udo.data_object.published && udo.visibility == Visibility.visible }.collect{ |udo| udo.data_object}
