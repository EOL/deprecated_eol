# It's all about tracking of users activity (create/delete comment, create/delete_tag, curate = {trusted, untrusted, show,
# hide, inappropriate}, ...) to use in data_object, comment and data_object_tags
