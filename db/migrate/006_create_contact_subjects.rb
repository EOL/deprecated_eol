class CreateContactSubjects < ActiveRecord::Migration
  def self.up
    ...
    ContactSubject.create!(:title => 'Media Contact (interviews, image requests)', :recipients => "example@example.com")    
    ...
    ContactSubject.create!(:title => 'Make a financial contribution', :recipients => "example@example.com")
