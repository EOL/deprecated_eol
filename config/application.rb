...
module Eol
  class Application < Rails::Application
    ...
    Rails.configuration.logo_uploads = OpenStruct.new(
      # Content server machine needs SFTP access to these folders:
      paperclip_path: "/uploads/images/collection_icons/",
      paperclip_url: "#{Rails.public_path}/uploads/images/collection_icons/"\
        ":class_:id.:extension",
      max_size: 5_242_880
    )
